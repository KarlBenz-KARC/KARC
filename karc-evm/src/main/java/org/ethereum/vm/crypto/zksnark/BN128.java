/**
 * Copyright (c) [2019] [ The Karc Developers ]
...
/**
 * Implementation of Barreto–Naehrig curve defined over abstract finite field.
 ...
 *
 * Curve equation: <br/>
 * Y^2 = X^3 + b, where "b" is a constant number belonging to corresponding
 * specific field <br/>
 * Point at infinity is encoded as <code>(0, 0, 0)</code> <br/>
 * <br/>
 *
 * This curve has embedding degree 12 with respect to "r" (see
 * {@link Params#R}), which means that "r" is a multiple of "p ^ 12 - 1", this
 * condition is important for pairing operation implemented in
