...
/**
 * EVM instruction set, see http://yellowpaper.io
 */
public enum OpCode {
    ...
    /**
     * (0xa[n]) log some data for some addres with 0..n tags [addr [tag0..tagn]
     * data]
     */
    ...
    /**
     * Returns the number stack items will be created after this operation.
     *
    ...
    /**
     * Indicates that value and message sender are propagated from parent to child
     * scope
     */
